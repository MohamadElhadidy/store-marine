          ...
          <form action="" className={`${loadingData && 'animate-pulse'} mt-10 flex flex-col  items-center`} onSubmit={submit}>
              <div className="grid gap-5 sm:grid-cols-8">
                ...
                <input dir="auto" type="text" disabled={loadingData}  ref={price}  defaultValue={item ? item?.price : ''} className="text-center font-[600] peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                  <label className="text-center font-bold absolute top-3 -z-10 origin-[0] -translate-y-6 scale-85 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:right-0 peer-focus:-translate-y-6 peer-focus:scale-90 peer-focus:text-blue-600 peer-focus:dark:text-blue-500"> سعر الوحدة </label>
                </div>
                <div className="relative z-0 col-span-3">
              ...
              <button type="submit" className={` relative rounded-md bg-green-800 ${loading ? "pl-10 pr-3" : "px-5"}  py-2 text-white flex items-center z-0 ml-3 hover:bg-green-700`} disabled={loadingData | loading}>
                ...
                <button onClick={handleClose}  disabled={loadingData | loading} type="button" className="  hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-md border border-gray-200 font-medium px-5 py-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 text-white dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">إلغاء</button>
              </div>
