      ...
      <form action="" className="mt-10 flex flex-col  items-center" onSubmit={submit}>
        <div className="grid gap-5 sm:grid-cols-8">
          ...
          <div className="flex mt-5 ">
            ...
            <button onClick={handleClose} type="button" className="  hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-md border border-gray-200 font-medium px-5 py-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 text-white dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">إلغاء</button>
          </div>
