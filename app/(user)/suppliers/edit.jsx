...
const Edit = ({ handleClose, data }) => {
  ...
  const handleChangeStore = (value) => setSupplier({ ...supplier, store : value})
    ...
    <Backdrop onClick={handleClose}>
      ...
      >
        ...
        <>
            ...
            <h1 className="text-3xl font-bold text-center">تعديل مورد</h1>
          ...
          <form action="" className={`${loadingData && 'animate-pulse'} mt-10 flex flex-col  items-center`} onSubmit={submit}>
              <div className="grid gap-5 sm:grid-cols-6">
                ...
                <input dir="auto" type="text" disabled={loadingData} ref={code}   defaultValue={supplier ? supplier?.code : ''} className="text-center font-[600] peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                ...
                <div className="relative z-0 col-span-3">
                <input dir="auto" type="text" ref={name} disabled={loadingData} defaultValue={supplier ? supplier?.name : ''} className="text-center font-[600] peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
            ...
            <div className="grid gap-5 sm:grid-cols-6">
              <div className="relative z-1 col-span-3">
                <Select ref={store} isDisabled={loadingData} onChange={value => handleChangeStore(value)} value={stores.find((e) => e.value == supplier?.store)} className="font-[600] peer block w-full appearance-none   bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" isSearchable={true} isClearable={true} isRtl={true} options={stores} placeholder={'اختر  المخزن '} />
              </div>
              <div className="relative z-0 col-span-3">
                <input dir="auto" type="text" ref={notes} disabled={loadingData} defaultValue={supplier ? supplier?.notes : ''} className="text-center font-[600] peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
